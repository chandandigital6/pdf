...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Update pdf data</div>
                    @if ($errors->any())
                    ...
                    <div class="card-body">
                        <form action="{{route('pdf.update',$pdf->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" value="{{$pdf->title}}" name="title" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="url" value="{{$pdf->url}}" name="url">
                                @error('url')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
